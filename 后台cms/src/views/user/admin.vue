	...
	export default {
		...
		methods: {
			...
			sub_edit_group() {
				...
				this.http.post('group/admin/edit_group',this.edit_group_form).then(res=>{
					this.$message({
						type: 'success',
						message: '修改成功!'
					});
			...
			del_group(id) {
				this.$confirm('确定删除该分组？', '提示', {
					...
					this.http.put('group/admin/del_group', {
						id: id
					}).then(res => {
						this.$message({
							type: 'success',
			...
			//提交修改
			sub_edit() {
				this.http.post('cms/admin/edit_admin', this.edit_form).then(res => {
					this.$message({
						type: 'success',
						message: '修改成功!'
					});
			...
			del_admin(id) {
				...
				this.$confirm('确定删除该管理员？', '提示', {
					...
					this.http.put('cms/admin/del_admin', {
						id: id
					}).then(res => {
						this.$message({
							type: 'success',
			...
			sub_add() {
				...
				this.http.post('cms/admin/add_admin', this.form).then(res => {
					this.$message({
						message: '添加成功',
						type: 'success'
					});

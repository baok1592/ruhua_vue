<template>
	<view class="tui-container">
		<view class="tui-upload-box">
			<view class="tui-image-item" v-for="(item,index) in img_arr" :key="index">
				<image :src="url + item" class="tui-item-img" @tap.stop="previewImage(index)" mode="aspectFill"></image>
			...
			<view v-if="isShowAdd" class="tui-upload-add" @tap="chooseImage">
				...
				<view v-if="type == 'photo'" class="tui-upload-icon">
					<image style="width: 50px; height: 50px;" src="../../static/images/photo.png"></image>
				</view>
				<view v-if="type == 'video'" class="tui-upload-icon">
					<image style="width: 40px; height: 40px;" src="../../static/images/video.png"></image>
				</view>
			</view>
		</view>
	</view>
						...
						success: function(res) {
							...
							if (res.statusCode == 200) {
								...
								if (d.status % 100 === 0) {
									...
									// d.data && (_this.imageList = d.data)
									_this.img_arr.push(d.data[0])
									console.log(_this.img_arr)

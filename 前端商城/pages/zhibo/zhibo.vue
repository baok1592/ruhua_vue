<template>
	<view class="zhibo">
		...
		<view class="zbo">
			<view class="zb" v-for="(item,index) of list" :key="index">
				<view class="zb_l">
				...
				<view class="zb_r">
					...
					<view class="zb_r_more">
						<view class="zb_r_more_l" v-for="(item,index) of list" :key="index" v-if="index<2">
...
.zhibo{
	...
	.zbo{padding:70px 10px 10px;
		.zb{display: flex;background-color:#fff;border-radius:5px;margin-bottom: 15px;box-shadow: 2px 0px 6px #F0F0F0;height: 180px;
			...
			.zb_r{padding: 6px 8px;
				.zb_r_tit{font-size: 15px;font-weight: 600;line-height: 25px;max-height: 50px;overflow: hidden;text-overflow: ellipsis;}
				.zb_r_des{color: #A7A7A7;font-size: 12px;line-height: 20px;height: 20px;overflow: hidden;margin:5px 0 10px;}
				.zb_r_more{display: flex;justify-content: space-between;width: 100%;
					.zb_r_more_l{width: 46%;position:relative;
						...
						width: 80px;border-radius: 0 0 5px 5px;color: #fff;font-size: 12px;

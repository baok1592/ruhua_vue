	...
	<view class="three" >
		<view class="top">
			...
			<view class="top_02">
				...
				<view><span class="top_02_s">0</span> &nbsp;</view>
				<view class="top_02_03">兑换 <view class="top_02_03_i"></view></view> 
			</view>
			<view class="top_03"  @click="toast"><button>签到领积分</button></view>
		</view>
		<view class='qdjl'>
...
<script>
	...
	export default {
		...
		methods:{
			_load(){  
				//总积分
				// this.$api.http.get('jifen').then(res=>{
				// 	this.jifen=res.num
				// 	//console.log(res)
				// })
				// //总积分
				// this.$api.http.get('qiandao').then(res=>{
				// 	this.qiandao=res
				// 	//console.log(res)
				// })
			},  
...
.three{
	...
	.top{background: url(../../imgs/asd.jpg) no-repeat 100% 100%;width: 100%;height: 200px;background-size: 100% 100%;margin-bottom: 110px;}
	...
	//除了微信小程序
	// #ifndef MP-WEIXIN
	.top_03{display: flex;justify-content: center;margin-top: 25px;}
	// #endif

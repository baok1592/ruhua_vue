...
<style lang="scss">
.discount{
	background-color:#f7f7f7;height: 100vh;font-size: 14px;
	...
	.pro_r{padding-left: 15px;box-sizing: border-box;display: flex;justify-content: space-between;flex-direction: column;}
	.pro_r_01{height: 50px;overflow: hidden;line-height: 20px;padding: 5px 0;overflow: hidden;}

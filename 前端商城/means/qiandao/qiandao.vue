<template>
	<view class="three">
		<view class="top" :style="'width: 100%;height: 200px;'">
			<view class="head"> 
				<img :src="web_url+'/static/web/asd.jpg'"></img>
			</view>
			<view class="top_01">
				<!-- <span>积分等级</span> -->
			</view>
			<view class="top_02">
				...
				<view class="top_02_03">兑换 <view class="top_02_03_i"></view>
				</view>
			</view>
		...
		<view class='qdjl'>
			...
			<view class='qdjl_01'>
				<view class='qdjl_01_1' v-for="(item,index) of qiandao" :key="index">
					...
					<view class='qdjl_01_1_03' v-else>
						<uni-icon type="checkmarkempty" size="30" color="#FA7077"></uni-icon>
					</view>
		...
		<view class="jfdh">
			<view class="jfdh_01" @click="toast">
				<view>
					<uni-icon type="star" size="35"></uni-icon>
				</view>
				积分兑换
			</view>
			<view class="jfdh_01" @click="toast">
		...
		<view class="zjf">
			<view class="zjf_tit">
				<uni-icon type="star"></uni-icon> <span>赚积分</span>
				<uni-icon type="star"></uni-icon>
			</view>
			<view class='rw'>
				<view class='rw_l'>
					<view class='rw_l_01'>
						<uni-icon type="chat" size="18" color="#fff"></uni-icon>
					</view>
					<view class='rw_l_02'>
			...
			<view class='rw'>
				<view class='rw_l'>
					...
					<view class='rw_l_02'>
						...
						<view class='rw_l_02_2'>一次性任务{{sfm}}</view>
					</view>
				</view>
				<view class='rw_r' @click="toast">做任务</view>
			</view>
...
<script>
	...
	export default {
		...
		onLoad() {
			this._load()
			this.sfm=uni.getStorageSync('level_one')
		},
		methods: {
			_load() {
